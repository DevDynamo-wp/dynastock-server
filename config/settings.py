...
# ============================================================
# IMPORTANT : à définir AVANT le tout premier "migrate"
# ============================================================
# On utilise un modèle User personnalisé (créé en Phase 2).
# Django doit le savoir dès le départ : changer cette ligne
# APRÈS avoir migré casserait toute la base. On la met donc
# maintenant, même si le modèle n'existe pas encore.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        ...
        'apps.subscriptions.permissions.HasWriteAccess',
    ),
}
